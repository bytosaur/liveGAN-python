# DCGAN
docker run --rm --user $(id -u):$(id -g) -v ${PWD}:/work/src facegan python main.py --dataset_name flickka --phase tfrecord --img_size 512


### Docker 
docker run -d --gpus device=0 -v $(pwd):/work/src livegan python main.py --dataset histo --phase train
